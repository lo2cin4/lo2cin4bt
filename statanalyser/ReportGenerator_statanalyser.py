...
【主控流程細節】
------------------------------------------------------------
- save_report() 為主入口，將各模組分析結果彙整並產生文字報告
- save_data() 支援匯出分析後資料為 csv、xlsx、json 等格式
- generate_strategy_recommendations() 根據分析結果自動產生策略建議
- 報表欄位與格式需與上游分析結果同步，並可自訂
...
class ReportGenerator:
    ...
    def __init__(self, output_dir: str = "stats_analysis_results"):
