...
class ParameterParser:
    ...
    @staticmethod
    def parse_entry_exit_parameters(parameters: list) -> Tuple[Dict[str, List], Dict[str, List]]:
        """
    ...
    @staticmethod
    def parse_indicator_param_structure(parameters: list) -> Dict[str, Dict[str, Dict[str, List]]]:
        """
