# Lo2cin4bt/backtester/Indicators_backtester.py
"""
...
【主控流程細節】
------------------------------------------------------------
- get_all_indicator_aliases() 回傳所有可用細分型態（如 MA1、BOLL2...）
- get_indicator_params() 產生指定指標的所有參數組合
- run_indicator() 調用指定指標並產生信號
- calculate_signals() 統一調用各指標的信號產生邏輯，支援細分型態與參數配置
- 支援自動註冊與擴充新指標
